...
@section('admin_content')
    ...
    <div class="sl-mainpanel">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mg-b-10-force">
                                    <label class="form-control-label">Sub Category: <span
                                                class="tx-danger">*</span></label>
                                    <select class="form-control select2" data-placeholder="Choose category"
                                            name="subcategory_id">@foreach($subcategory as $item)
                                            <option value="{{$item->id}}" <?php if ($item->id == $product->subcategory_id) {
                                                echo "selected";
                                            } ?>
                                ...
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <select class="form-control select2" data-placeholder="Choose category"
                                        ...
                                        @foreach($brand as $item)
                                            <option value="{{$item->id}}" <?php if ($item->id == $product->brand_id) {
                                                echo "selected";
                                            } ?>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Product Details: <span
                                                class="tx-danger">*</span></label>
                                    <textarea class='form-control' name="product_details" id="summernote">{{$product->product_details}}
                                    </textarea>
                ...
                <form method="post" action="{{url('update/product/photo/'.$product->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <label class="form-control-label">Image One (Main): <span
        ...
        <input type="hidden" name="old_one" value="{{$product->image_one}}">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <label class="form-control-label">Image Two (Side Pick #2): <span
                                        class="tx-danger">*</span>
                            </label>
                            <br>
                            <label class="custom-file">
        ...
        <input type="hidden" name="old_two" value="{{$product->image_two}}">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <label class="form-control-label">Image three (Pic #3): <span
                                        class="tx-danger">*</span>
                            </label>
                            <br>
                            <label class="custom-file">
        ...
        <input type="hidden" name="old_three" value="{{$product->image_three}}">
                    ...
                    <br>
                    <button type="submit" class="btn btn-sm btn-warning">Update Photos </button>
                </form>
            </div>
