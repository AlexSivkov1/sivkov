    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>Requested For Return</h5>

            </div><!-- sl-page-title -->

            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Orders Requested For Return</h6>
                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @foreach($order as $row)
                            <tr>
                                ...
                                <td><a href="{{URL::to('admin/approve/return/'. $row->id)}}" class="btn btn-sm btn-info">Approve</a>
                                </td>
