...
@section('admin_content')
 ...
 {{--   @php
        ...
        $today_delivered = DB::table('orders')->where('date', $date)->where('status', 3)->sum('total');

        $this_month_delivered = DB::table('orders')->where('month', $month)->where('status', 3)->sum('total');

        $all_time_delivered = DB::table('orders')->where('status', 3)->sum('total');
            ...
            <div class="row row-sm">
                ...
                <div class="col-sm-6" style="margin-top:10px;">
                    <div class="card pd-20 bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
                            <h3 class="mg-b-0 tx-white tx-lato tx-bold"> ${{--{{$all_time_delivered}}--}}</h3>
                        </div><!-- card-body -->
