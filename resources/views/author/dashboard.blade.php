...
<section id="about">
        ...
        <div class="row color-bg">
            <div class="col-md-6 nopadding features-intro-img">
                <div class="about-image" style="background-image:url({{asset('public/frontend/img/about1.png')}})"></div><!-- about image 1 -->
            </div>
        ...
        <div class="row color-bg">
            <div class="col-md-6 nopadding features-intro-img">
                <div class="about-image" style="background-image:url({{asset('public/frontend/img/about3.png')}})"></div><!-- about image 3 -->
            </div>
            <div class="col-md-6 about-text">
    ...
    <div class="container">
        ...
        <div class="row">
                <ul class="slides">
                    <li>
                        <!-- Blog Entry 1 -->
                        @foreach($bposts as $item)

                        <div class="col-md-4"  {{--  style="height:400px" wp4--}}>

                                <div class="img">
                                    <img src="{{$item->post_image}}" class="grayscale" style="width: 350px" height="250px"                                                alt="{{$item->post_title}}"><!-- Blog Image -->
                                </div>
                            <br>

                            <h2>{{$item->post_title}}</h2><!-- Headline -->
                            <p>{!!$item->details!!}</p><!-- Description-->
                            <br>
