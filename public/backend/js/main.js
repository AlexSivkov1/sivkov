...
(function($) {
	...
	<div class="col-lg-2 order-lg-1 order-2" >
	 <ul class="image_list">
	 <li class="active" data-image="{{ asset( $product->image_one ) }}"><img src="{{ asset( $product->image_one ) }}" alt=""></li>
	 ...
	 {{--Selected Image--}}
	 <div class="col-lg-5 order-lg-2 order-1 zoom">
	 <div class="image_selected" id="zoom">
